...
async def generate_branding_content(brand_data: dict) -> dict:
    ...
    prompt = f"""
    You are an expert branding agency. Create a comprehensive brand identity for the following product:
        ...
        def call_gemini():
            return client.models.generate_content(
                ...
                config=types.GenerateContentConfig(
                    system_instruction="You are a professional brand strategist and creative copywriter.",
